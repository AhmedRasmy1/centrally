...
class AppTextStyles {
  ...
  static TextStyle headlineSmall = _style(
    18,
    FontWeightManager.semiBold,
    ColorManager.textPrimary,
  );
  ...
  static TextStyle titleSmall = _style(
    14,
    FontWeightManager.medium,
    ColorManager.textPrimary,
  );
  ...
  static TextStyle bodySemiBold = _style(
    14,
    FontWeightManager.semiBold,
    ColorManager.textPrimary,
  );
  ...
  // Label
  static TextStyle labelLarge = _style(
    14,
    FontWeightManager.medium,
    ColorManager.textPrimary,
  );
  static TextStyle labelSmall = _style(
    12,
    FontWeightManager.medium,
    ColorManager.textSecondary,
  );
